...
class Greeting(ndb.Model):
    """ Models an individual Guestbook entry with author, content, date."""
    ...
    def get(self):
        ...
        for greeting in greetings:
            ...
            if greeting.author:
                ...
                self.reponse.write('An anonymous person wrote:')
        ...
        # Write the submission form and the fotter of the page
